...
func creer_sort(pos1: Vector3, pos2: Vector3, is_harry = true):
	...
	if is_harry:
		material.albedo_color = Color("da6254") # Rouge
	else:
		material.albedo_color = Color("68e87f") # Vert
